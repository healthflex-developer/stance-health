                        ...
                        <ul className="ot-nav">
                            <li>
                                {currentPath.includes('/whitefield') ? (
                                    ...
                                    <a href="https://book.stance.health/?utm_source=website&utm_medium=cta&utm_campaign=website_booking" className='main-btn' target='_blank' rel="noreferrer">
                                        Book an Appointment
                                    </a>
                                )}
                            </li>
        ...
        <div className={`mob-menu ${menuOpen && 'active'}`}>
            ...
            <ul>
                ...
                {currentPath.includes('/whitefield') ? (
                    ...
                    <li>
                        <a href="https://book.stance.health/?utm_source=website&utm_medium=cta&utm_campaign=website_booking" target='_blank' rel="noreferrer" onClick={()=>setMenuClose(false)} className='text-white hover:text-[#CDFE71] transition-colors py-2'>
                            Book an Appointment
                        </a>
                    </li>
                )}
